...
public class MyBatisPlusGenerator {
  ...
  public static void main(String[] args) throws SQLException {
    ...
    config.setActiveRecord(true) // 是否支持AR模式
        .setAuthor("liuwei") // 作者
        .setOpen(false).setOutputDir(projectPath + "/base-auth-provider/src/main/java").setFileOverride(true) // 文件覆盖
    ...
    pkConfig.setParent("com.tcloudsoft.auth.provider").setMapper("mapper")// dao
    ...
    focList.add(new FileOutConfig(templatePath) {
      ...
      public String outputFile(TableInfo tableInfo) {
        ...
        return projectPath + "/base-auth-provider/src/main/resources/mapper/" + tableInfo.getEntityName() + "Mapper"
            + StringPool.DOT_XML;
      }
    });
