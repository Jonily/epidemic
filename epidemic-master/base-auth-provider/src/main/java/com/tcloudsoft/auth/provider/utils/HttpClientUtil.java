...
public class HttpClientUtil {
  ...
  public static String sendGetRequest(String reqURL, String decodeCharset) {
    ...
    try {
      ...
      if (null != entity) {
        ...
        responseContent =
            EntityUtils.toString(entity, decodeCharset == null ? "UTF-8" : decodeCharset);
      ...
      logger.debug(
          "该异常通常是协议错误导致,比如构造HttpGet对象时传入的协议不对(将'http'写成'htp')或者服务器端返回的内容不符合HTTP协议要求等,堆栈信息如下", e);
  ...
  public static String sendPostRequest(String reqURL, Map<String, String> params,
    ...
    try {
      httpPost.setEntity(
          new UrlEncodedFormEntity(formParams, encodeCharset == null ? "UTF-8" : encodeCharset));
  ...
  public static String sendPostByJson(String url, String body) throws Exception {
    ...
    try {
      ...
      // post.setHeader("X-OpenStack-Ironic-API-Version", "1.46");
  ...
  public static String doDelete(String data, String url) throws IOException {
    ...
    try {
      ...
      // httpDelete.setHeader("X-OpenStack-Ironic-API-Version", "1.46");
  ...
  public static String executeHttpPatch(String url, String jsonParam) {
    // JSONObject resultObj = null;
    HttpClient httpClient = new DefaultHttpClient();
    HttpPatch httpPatch = new HttpPatch(url);
    httpPatch.setHeader("Content-type", "application/json");
    // httpPatch.setHeader("X-OpenStack-Ironic-API-Version", "1.46");
  ...
  public static String executeHttpPut(String url, String jsonParam) {
    // JSONObject resultObj = null;
    HttpClient httpClient = new DefaultHttpClient();
    HttpPut httpPut = new HttpPut(url);
    // HttpPatch httpPatch = new HttpPatch(url);
    httpPut.setHeader("Content-type", "application/json");
    // httpPut.setHeader("X-OpenStack-Ironic-API-Version", "1.46");
